...
set this when running make to add more options<br />
...
file with all docs using the templates in
...
of \$(PYPI_TOKEN_FILE) to the console for the user to copy and paste in
...
<main class="pdoc">
<section class="module-info">
<a class="pdoc-button git-button" href="https://github.com/mivanit/python-project-makefile-template/blob/0.0.6/helloworld.py">Edit
on GitHub</a>
<h1 class="modulename">
...
</span><span id="critical_function-14"><a href="#critical_function-14"><span class="linenos">14</span></a>
<span class="k">raise</span>
<span class="ne">NotImplementedError</span><span class="p">(</span><span class="s2">"This
function is not implemented yet"</span><span class="p">)</span> </span>
</pre>
...
<main class="pdoc">
<section class="module-info">
<a class="pdoc-button git-button" href="https://github.com/mivanit/python-project-makefile-template/blob/0.0.6/other.py">Edit
on GitHub</a>
<h1 class="modulename">
