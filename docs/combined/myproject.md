> docs for [`myproject`](https://github.com/mivanit/python-project-makefile-template) v0.5.4
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/v0.5.4/myproject/__init__.py)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/v0.5.4/myproject/__init__.py#L0-L0)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/v0.5.4/myproject/helloworld.py)

# `myproject.helloworld` { #myproject.helloworld }

dummy module

[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/v0.5.4/myproject/helloworld.py#L0-L15)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/v0.5.4/myproject/helloworld.py#L8-L10)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/v0.5.4/myproject/helloworld.py#L14-L16)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/v0.5.4/myproject/other.py)

# `myproject.other` { #myproject.other }

a module

[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/v0.5.4/myproject/other.py#L0-L6)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/v0.5.4/myproject/other.py#L5-L7)
