> docs for [`myproject`](https://github.com/mivanit/python-project-makefile-template) v0.1.1
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/0.1.1/__init__.py)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/0.1.1/__init__.py#L0-L2)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/0.1.1/helloworld.py)

# `myproject.helloworld` { #myproject.helloworld }


[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/0.1.1/helloworld.py#L0-L11)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/0.1.1/helloworld.py#L6-L7)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/0.1.1/helloworld.py#L11-L12)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/0.1.1/other.py)

# `myproject.other` { #myproject.other }


[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/0.1.1/other.py#L0-L2)
...
[View Source on GitHub](https://github.com/mivanit/python-project-makefile-template/blob/0.1.1/other.py#L2-L3)
